...
module.exports = {
  ...
  'step 3 - validate home company news items' : (driver) => {
    ...
    driver.waitForTextByCss('[data-testid=company-news-item-title]', 'US - Employee Travel Office Contact');
    driver.waitForTextByCss('[data-testid=company-news-item-date]', 'Apr 10, 2019');
    // driver.waitForTextByCss('[data-testid=show-more-button]', 'Show all');
  ...
  'step 4 - Validate home company resources items' : (driver) => {
    ...
    // check tabs titles
    driver.waitForTextByCss('[data-testid=tabs-button-0]', 'My Local Travel Tools');
    driver.waitForTextByCss('[data-testid=tabs-button-1]', 'My Global Travel Tools');
    // check first tab first links
    driver.waitForTextByCss('[data-testid=company-resource-text-150951239]', 'Global Travel Policy - CWT Employee Travel');
    driver.waitForAttributeContainsByCss('[data-testid=company-resource-link-150951239]', 'href', 'https://carlsonwagonlit.jiveon.com/docs/DOC-30684');
    // click on the second tab
    driver.waitAndClickByCss('[data-testid=tabs-button-1]');
    // check second tab links
    driver.waitForAttributeContainsByCss('[data-testid=company-resource-link-150951239]', 'href', 'https://carlsonwagonlit.jiveon.com/docs/DOC-30684');
    driver.waitForAttributeContainsByCss('[data-testid=company-resource-link-36256]', 'href', 'http://www.carlsonwagonlit.com');
    driver.waitForAttributeContainsByCss('[data-testid=company-resource-link-36270]', 'href', 'http://timeanddate.com/weather');
    driver.waitForAttributeContainsByCss('[data-testid=company-resource-link-36112]', 'href', 'http://timeanddate.com/worldclock');
    driver.waitForAttributeContainsByCss('[data-testid=company-resource-link-36119]', 'href', 'http://metric-conversions.org');
    // click on the third link (in the second tab)
    driver.waitAndClickByCss('[data-testid=company-resource-link-36270]');

    // Switch to the second tab [1]
    driver.switchToTab(1);
    // Validate second tab URL
    driver.waitForUrlToContain('timeanddate.com/weather', 20000);
    // Close second tab
    driver.closeWindow();
    driver.pause(1000);
