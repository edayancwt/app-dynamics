...
module.exports = {
  ...
  'step 2 - Validate home navigation links' : (driver) => {
    ...
    driver.waitForUrlToContain('travel.mycwt.com', 30000);
    ...
    // driver.pause(2000);
    // driver.waitForUrlToContain('travel.mycwt.com/my-travelers', 20000);
    // // Home
    // driver.waitAndClickByCss('[data-testid=myCWT-logo]');
    // driver.waitForUrlToContain('travel.mycwt.com', 30000);

    // Book a hotel
    driver.waitForElementVisible('[data-testid=header-navigation-bookHotel]');
    driver.pause(2000);
    ...
    // driver.pause(2000);
    // driver.waitForUrlToContain('travel.mycwt.com/book-a-flight#/', 20000);
    // // Home
    // driver.waitAndClickByCss('[data-testid=myCWT-logo]');
    // driver.waitForUrlToContain('travel.mycwt.com', 30000);
    ...
    // driver.waitForUrlToContain('admin-travel.mycwt.com/group/incredibles_subunit_4-incredible_tests1', 20000);
    driver.closeWindow();
    ...
    driver.waitForUrlToContain('travel.mycwt.com/account-settings', 20000);
    ...
    driver.waitForUrlToContain('profile.mycwt.com/profile/profile-mgmt/edit/portalblue', 20000);
    // Close second tab
    driver.closeWindow();
    driver.pause(1000);
