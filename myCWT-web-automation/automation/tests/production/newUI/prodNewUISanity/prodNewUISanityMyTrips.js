...
module.exports = {
  ...
  'step 3 - Validate view trips past' : (driver) => {
    ...
    driver.waitForTextByCss('[data-testid=trip-277560058] [data-testid=trip-name]', 'Trip to Bangkok');
    // Past trip location
    driver.waitForTextByCss('[data-testid=trip-277560058] [data-testid=trip-address-destination]', 'Bangkok, TH');
    // trip duration
    driver.waitForTextByCss('[data-testid=trip-277560058] [data-testid=trip-dates]', 'Jul 29 - Oct 29, 2016 | 93 days');
    ...
    // Flight item
    driver.waitForAttributeContainsByCss('[data-testid=trip-277560058] [data-testid=air-1] [data-testid=segment-icon]', 'class', 'CwtIcons__StyledIcon-sc-1zecbe-0 styles__Icon-sc-10wf0m2-10 eGKQsK CwtIcons-sc-1zecbe-1 tMHET');
    driver.waitForTextByCss('[data-testid=trip-277560058] [data-testid=air-1] [data-testid=segment-description]', 'WLG - SYD - BKK\n- PHL - PHL');
  },
