...
'@tags': ['stage', 'sanity', 'portal', 'travel arranger'],
  ...
  'step 2 - Validate home header items' : (driver) => {
    ...
    driver.waitForTextByCss('[data-testid=hero-content] [data-testid=pill-button]', 'BOOK A FULL TRIP');
    driver.waitForAttributeContainsByCss('[data-testid=hero-content] [data-testid=pill-button]', 'href', 'https://accounts.mycwt.com/idp/startSSO.ping?PartnerSpId=portal%3Aprod%3Acwt%3Asaml2');
  },

  'step 3 - Validate travel arranger my travelers list' : (driver) => {
    // click on my travelers link
    driver.waitForElementVisible('[data-testid=header-navigation-myTravelers]');
    driver.pause(2000);
  ...
  'step 4 - Validate first traveler' : (driver) => {
    // traveler name
    driver.waitForTextByCss('[data-testid=traveler-1] [data-testid=ta-name]', 'Portal Sanity Sanity One');
    // upcoming trip
    driver.waitForTextByCss('[data-testid=traveler-1] [data-testid=upcoming-trip-link-1]', 'Trip to Tokyo');
    // date
    driver.waitForTextByCss('[data-testid=traveler-1] [data-testid=ta-trip-dates]', 'Jun 4 - Jun 10, 2025');
    // missing hotel
  ...
  'step 7 - Validate travel arranger my travelers links' : (driver) => {
    ...
    driver.waitForTextByCss('[data-testid=traveler-trips]', 'PORTAL SANITY SANITY ONE');
    // trip title
    driver.waitForTextByCss('[data-testid=hero-title]', 'Portal Sanity Sanity One\'s Trip to Tokyo');
    ...
    driver.waitForTextByCss('[data-testid=trip-277558572] [data-testid=trip-dates]', 'Jun 4 - Jun 10, 2025');
    // back to my travelers list
    driver.waitAndClickByCss('[data-testid=header-navigation-myTravelers]');
    ...
    driver.waitForTextByCss('.notification-banner--travel-arranger', 'Booking a hotel for Portal Sanity Sanity One');
  },
