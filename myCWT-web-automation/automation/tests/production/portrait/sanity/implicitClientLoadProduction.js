...
//---------------------------------File templates--------------------------------------------
let createTemplate = `${NVClientName}|${NVSubunit}|${NVTravellerType}|myid${randomNumberForCreate}|Grape|One|grape${randomNumberForCreate}@yopmail.com`;
let updateTemplate = `${NVClientName}|${NVSubunit}|${NVTravellerType}|myid${randomNumberForCreate}|Grape|One ${randomString}|grape${randomNumberForCreate}@yopmail.com`;

let travellerFullName = 'Grape One';
// Email extracted from the template creation
let travellerEmail = createTemplate.replace(/.*(?=grape)/g, '');
