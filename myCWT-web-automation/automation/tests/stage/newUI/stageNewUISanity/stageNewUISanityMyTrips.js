...
module.exports = {
  ...
  "step 2 - Validate view trips upcoming": driver => {
    ...
    driver.waitForTextByCss(
      "[data-testid=upcoming-trips-section-title]",
      "My upcoming trips (1)"
    );
    // trip title
    driver.waitForTextByCss(
    ...
    // trip location
    driver.waitForTextByCss(
      "[data-testid=trip-971131] [data-testid=trip-address-destination]",
      "Tokyo, JP"
    );
    // trip duration
    driver.waitForTextByCss(
    ...
    driver.waitForAttributeContainsByCss(
      "[data-testid=air-1] [data-testid=segment-icon]",
      "class",
      "CwtIcons__StyledIcon-sc-1zecbe-0 styles__Icon-sc-10wf0m2-10 eGKQsK CwtIcons-sc-1zecbe-1 tMHET"
    );
    driver.waitForTextByCss(
      "[data-testid=air-1] [data-testid=segment-description]",
      "LHR - SVO - NRT"
    );
    // // missing hotel item //TODO: have a defect
    ...
    //car item
    driver.waitForAttributeContainsByCss(
      "[data-testid=car-1] [data-testid=segment-icon]",
      "class",
      "CwtIcons__StyledIcon-sc-1zecbe-0 styles__Icon-sc-10wf0m2-10 eGKQsK CwtIcons-sc-1zecbe-1 figTwR"
    );
    driver.waitForTextByCss(
      "[data-testid=car-1] [data-testid=segment-description]",
      "DOLLAR"
    );
    // + number //TODO: have a defect
    // driver.waitForTextByCss('[data-testid=more-items] [data-testid=trip-card-more]', '+ 2');
    // driver.waitForTextByCss('[data-testid=more-items] [data-testid=tooltip-base]', 'More items');
  },
  ...
  "step 3 - Validate view trips past": driver => {
    ...
    driver.waitForTextByCss(
      "[data-testid=past-trips-section-title]",
      "My past trips (1)"
    );
    ...
    driver.waitForAttributeContainsByCss(
      ...
      "placeholder",
      "Search for city airport or landmark"
    );
    // Year title
    driver.waitForTextByCss("[data-testid=my-trips-year-divider]", "2016");
    // Past trip main title
    driver.waitForTextByCss(
      "[data-testid=trip-969599] [data-testid=trip-name]",
      "Trip to\nBangkok"
    );
    // Past trip location
    driver.waitForTextByCss(
      "[data-testid=trip-969599] [data-testid=trip-address-destination]",
      "Bangkok, TH"
    );
    // trip duration
    driver.waitForTextByCss(
      "[data-testid=trip-969599] [data-testid=trip-dates]",
      "Jul 29 - Oct 29, 2016 | 93 days"
    );
    ...
    //   this.assert.equal(textValue, "Starts onJul 29  -  EndsOct 29, 2016 | 91 nights");
    // });

    // Flight item
    driver.waitForAttributeContainsByCss(
      "[data-testid=trip-969599] [data-testid=air-1] [data-testid=segment-icon]",
      "class",
      "CwtIcons__StyledIcon-sc-1zecbe-0 styles__Icon-sc-10wf0m2-10 eGKQsK CwtIcons-sc-1zecbe-1 tMHET"
    );
    // driver.waitForTextByCss('[data-testid=trip-969599] [data-testid=air-1] [data-testid=segment-description]', 'WLG - SYD - BKK - PHL\n- PHL'); //TODO: defect#784
  },
  ...
  "step 4 - Validate view trips search": driver => {
    ...
    //validate no trips message display
