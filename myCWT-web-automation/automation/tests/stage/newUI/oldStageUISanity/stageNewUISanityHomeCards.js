...
module.exports = {
  ...
  'step 3 - Validate home itinerary missing hotel card' : (driver) => {
    ...
    driver.waitAndClickByCss('[data-testid=missingAccommodation-1] [data-testid=search-button]');
    // Validate booking page URL
    driver.waitForUrlToContain('travel.stage-mycwt.com/book-a-hotel#/hotel-results', 20000);
    // back to home
    driver.back();
  },
