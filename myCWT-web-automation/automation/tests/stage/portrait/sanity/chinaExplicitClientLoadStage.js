...
let clientName = 'Yeego Test Client';
let subunit = 'CN-Yeego';
let travellerType1 = 'General';
let travellerType2 = 'VIP';
let dataFolder = 'automation/tests/stage/portrait/sanity/portraitData';
let specExplicit = 'Yeego Test Client Spec';
//---------------------------------File templates--------------------------------------------
let createTemplate = `create|${clientName}|${subunit}|${travellerType1}|myid${randomNumberForCreate}|Panda|One|panda${randomNumberForCreate}@yopmail.com`;
let updateTemplate = `update|${clientName}|${subunit}|${travellerType1}|myid${randomNumberForCreate}|Panda|One ${randomString}|panda${randomNumberForCreate}@yopmail.com`;
let deleteTemplate = `delete|${clientName}|${subunit}|${travellerType1}|myid${randomNumberForCreate}|Panda|One ${randomString}|panda${randomNumberForCreate}@yopmail.com`;

// Email extracted from the template creation
let travellerEmail = updateTemplate.replace(/.*(?=panda)/g, '');
let travellerName = `Panda One ${randomString}`;

module.exports = {

  '@tags': ['clientLoad', 'HRFeeds', 'portrait', 'explicit', 'china', 'yeego'],
  ...
  'step 0 - Create files': () => {
    // Add "create" file
    fs.writeFile(`${dataFolder}/chinaDataClientLoadCreate${randomNumberForCreate}.txt`, createTemplate, () => {
      console.log('Create file was created');
    });
    // Add "update" file
    fs.writeFile(`${dataFolder}/chinaDataClientLoadUpdate${randomNumberForCreate}.txt`, updateTemplate, () => {
      console.log('Update file was created');
    });
    // Add "delete" file
    fs.writeFile(`${dataFolder}/chinaDataClientLoadDelete${randomNumberForCreate}.txt`, deleteTemplate, () => {
  ...
  'step 2 - Create load': (browser) => {
    browser
      ...
      // Add data file path
      .waitAndSetValueByCss(pageClientMaint.selectors.basicInformation.fileLocationInput, 'C:\\fakepath\\chinaDataClientLoadCreate.txt')
      ...
      // Add top value
      .waitAndSetValueByXpath('//*[@id="PALForm"]/table/tbody/tr[3]/td[2]/table/tbody/tr[1]/td/table/tbody/tr/td/table/tbody/tr/td/div/table/tbody/tr/td[2]/table/tbody/tr[2]/td[3]/input[1]', clientName)
      // Add sub value
      .waitAndSetValueByCss('#PALForm > table > tbody > tr:nth-child(3) > td:nth-child(2) > table > tbody > tr:nth-child(1) > td > table > tbody > tr > td > table > tbody > tr > td > div > table > tbody > tr > td:nth-child(2) > table > tbody > tr:nth-child(3) > td > div > table > tbody > tr:nth-child(2) > td:nth-child(4) > input[type=text]:nth-child(1)', subunit)
      // Add traveller type
      .waitAndSetValueByCss('#PALForm > table > tbody > tr:nth-child(3) > td:nth-child(2) > table > tbody > tr:nth-child(1) > td > table > tbody > tr > td > table > tbody > tr > td > div > table > tbody > tr > td:nth-child(2) > table > tbody > tr:nth-child(3) > td > div > table > tbody > tr:nth-child(3) > td:nth-child(5) > input[type=text]:nth-child(1)', travellerType1)
      // Add second traveller type
      .waitAndSetValueByCss('#PALForm > table > tbody > tr:nth-child(3) > td:nth-child(2) > table > tbody > tr:nth-child(1) > td > table > tbody > tr > td > table > tbody > tr > td > div > table > tbody > tr > td:nth-child(2) > table > tbody > tr:nth-child(3) > td > div > table > tbody > tr:nth-child(4) > td:nth-child(5) > input[type=text]:nth-child(1)', travellerType2)
      // Click on submit
      ...
      // Upload data file
      .fileUpload(`${dataFolder}/chinaDataClientLoadCreate${randomNumberForCreate}.txt`)
  ...
  'step 3 - Update load': (browser) => {
    browser
      ...
      .waitAndClickOnText(specExplicit)
      // Navigate to Test/Run Load
      .waitAndClickOnText('Test/Run Load')
      // Upload data file
      .fileUpload(`${dataFolder}/chinaDataClientLoadUpdate${randomNumberForCreate}.txt`)
      // Click on Test button
      .waitAndClickByXpath(pageClientMaint.selectors.testRunLoad.runButton)
      // Navigate to file mapping
      .waitAndClickOnText('File Mapping')
  ...
  'step 7 - Delete load': (browser) => {
    browser
      ...
      .waitAndClickOnText('Test/Run Load')
      // Upload data file
      .fileUpload(`${dataFolder}/chinaDataClientLoadDelete${randomNumberForCreate}.txt`)
      // Click on Test button
      .waitAndClickByXpath(pageClientMaint.selectors.testRunLoad.runButton)
      // Navigate to file mapping
      .waitAndClickOnText('File Mapping')
