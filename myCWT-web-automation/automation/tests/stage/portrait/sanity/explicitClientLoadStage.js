...
let NVTravellerType2 = 'Test';
let dataFolder = 'automation/tests/stage/portrait/sanity/portraitData';
let specExplicitNV = 'AutomationSpecExplicitNV';
//---------------------------------File templates--------------------------------------------
let createTemplate = `create|${NVClientName}|${NVSubunit}|${NVTravellerType1}|myid${randomNumberForCreate}|Lemon|One|lemon${randomNumberForCreate}@yopmail.com`;
let updateTemplate = `update|${NVClientName}|${NVSubunit}|${NVTravellerType1}|myid${randomNumberForCreate}|Lemon|One ${randomString}|lemon${randomNumberForCreate}@yopmail.com`;
let deleteTemplate = `delete|${NVClientName}|${NVSubunit}|${NVTravellerType1}|myid${randomNumberForCreate}|Lemon|One ${randomString}|lemon${randomNumberForCreate}@yopmail.com`;

// Email extracted from the template creation
let travellerEmail = updateTemplate.replace(/.*(?=lemon)/g, '');
let travellerName = `Lemon One ${randomString}`;
...
module.exports = {
  ...
  'step 2 - Create load': (browser) => {
    browser
      ...
      // Add sub value
      .waitAndSetValueByCss('#PALForm > table > tbody > tr:nth-child(3) > td:nth-child(2) > table > tbody > tr:nth-child(1) > td > table > tbody > tr > td > table > tbody > tr > td > div > table > tbody > tr > td:nth-child(2) > table > tbody > tr:nth-child(4) > td > div > table > tbody > tr:nth-child(2) > td:nth-child(4) > input[type=text]:nth-child(1)', NVSubunit)
      // Add traveller type
      .waitAndSetValueByCss('#PALForm > table > tbody > tr:nth-child(3) > td:nth-child(2) > table > tbody > tr:nth-child(1) > td > table > tbody > tr > td > table > tbody > tr > td > div > table > tbody > tr > td:nth-child(2) > table > tbody > tr:nth-child(4) > td > div > table > tbody > tr:nth-child(3) > td:nth-child(5) > input[type=text]:nth-child(1)', NVTravellerType1)
      // Add second traveller type
      .waitAndSetValueByCss('#PALForm > table > tbody > tr:nth-child(3) > td:nth-child(2) > table > tbody > tr:nth-child(1) > td > table > tbody > tr > td > table > tbody > tr > td > div > table > tbody > tr > td:nth-child(2) > table > tbody > tr:nth-child(4) > td > div > table > tbody > tr:nth-child(4) > td:nth-child(5) > input[type=text]:nth-child(1)', NVTravellerType2)
      // Click on submit
