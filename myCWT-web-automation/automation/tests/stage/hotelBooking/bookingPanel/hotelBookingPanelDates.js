...
module.exports = {
  ...
  'step 2 - Dates Field - Validate home booking panel - dates' : (driver) => {
    // Check in
  ...
  'step 3 - Dates Field - Validate Dates field is open automatically' : (driver) => {
    driver.pause(2000);
  ...
  'step 4 - Dates Field - Validate default date" ' : (driver) => {
    ...
    driver.getText('.slick-slide[data-index="0"] .new-day-start', function (result) {
      let regex = /\W\S\w\D/g;
  ...
  'step 5 - Dates Field - Invalid dates - Past days' : (driver) => {
    driver.refresh();
    // Scroll up to be safe and see clicked elements
  ...
  'step 6 - Dates Field - Invalid dates - more than 28 days' : (driver) => {
    driver.refresh();
    // Scroll up to be safe and see clicked elements
    driver.execute(function() { window.scrollBy(0, -715); }, []);
    driver.pause(5000);
  ...
  'step 7 - Dates Field - Date selection' : (driver) => {
    driver.refresh();
    // Scroll up to be safe and see clicked elements
    driver.execute(function() { window.scrollBy(0, -715); }, []);
    driver.pause(5000);
    ...
    driver.waitForAttributeContainsByXpath('//*[@id="hotel-search-panel-row"]/aside[2]/div[1]/div[2]/div/div[1]/div[3]/div', 'class', 'DateInput__display-text--focused');
  ...
  'step 8 - Dates Field - Date selection - Check In update - part I' : (driver) => {
    driver.refresh();
    // Scroll up to be safe and see clicked elements
    driver.execute(function() { window.scrollBy(0, -715); }, []);
    driver.pause(5000);
  ...
  'step 9 - Dates Field - Date selection - Check In update - part II' : (driver) => {
    // Click on date input
    ...
    // Validate that the date-picker is open
    driver.waitForAttributeContainsByXpath('//*[@id="hotel-search-panel-row"]/aside[2]/div[1]/div[2]/div/div[2]/div/div/div[2]/div[2]', 'class', 'transition-container'); // old: //*[@id="hotel-search-panel-row"]/aside[1]/div[1]/div[2]/div/div[2]/div/div/div[2]/div[2]
    driver.pause(1000);
  },

  'step 10 - Dates Field - Date selection - Check Out update' : (driver) => {
    ...
    driver.useXpath();
    driver.waitForElementNotPresent('//*[@id="hotel-search-panel-row"]/aside[2]/div[1]/div[2]/div/div[2]/div/div/div[2]/div[2]', 1000); // //*[@id="hotel-search-panel-row"]/aside[1]/div[1]/div[2]/div/div[2]/div/div/div[2]/div[2]
    // Validate that Date inputs filled with text
    driver.waitForTextByCss('#start-date-input ~ .DateInput__display-text.DateInput__display-text--has-input', ' ');
    driver.waitForTextByCss('#end-date-input ~ .DateInput__display-text.DateInput__display-text--has-input', ' ');
  ...
  'step 11 - Dates Field - Number of nights' : (driver) => {
    driver.refresh();
    // Scroll up to be safe and see clicked elements
    driver.execute(function() { window.scrollBy(0, -715); }, []);
    driver.pause(5000);
    ...
    //   return true;
    // }, []);
    driver.selectSpecificHotelDates(10, 23);
    // Click on date input
    driver.moveToElement('#start-date-input', 10, 10);
    driver.pause(200);
    driver.mouseButtonDown(0);
    ...
    //   return true;
    // }, []);
    driver.selectSpecificHotelDates(9, 24);
    // Click on date input
    driver.moveToElement('#start-date-input', 10, 10);
    driver.pause(200);
    driver.mouseButtonDown(0);
  ...
  'step 12 - Dates Field - Navigation' : (driver) => {
    // Click on date input
    driver.moveToElement('#start-date-input', 10, 10);
    driver.pause(200);
    driver.mouseButtonDown(0);
   ...
   // driver.waitAndClickByCss('.DayPickerNavigation__next');
    ...
    driver.moveToElement('.backGroundDiv', 10, 10);
    driver.pause(200);
    driver.mouseButtonDown(0);
    driver.pause(200);
    driver.mouseButtonUp(0);
